<?php
/*
MySimplifiedSQL is an easy-to-use PHP class to interact with a SQL database. Currently this makes use of the MySQLi extension and therefore only supports MySQL/MariaDB, SQLite for example is not supported.
...
GitHub: https://github.com/Nixtren/MySimplifiedSQL
*/
